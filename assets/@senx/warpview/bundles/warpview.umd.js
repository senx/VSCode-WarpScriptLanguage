(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('moment-timezone'), require('deep-equal'), require('plotly.js/dist/plotly'), require('plotly.js'), require('rxjs'), require('rxjs/operators'), require('rxjs/internal/observable/of'), require('@angular/common/http'), require('fitty'), require('moment'), require('d3'), require('d3-selection'), require('leaflet'), require('leaflet.heat'), require('leaflet.markercluster'), require('nouislider'), require('@angular/forms'), require('angular-resize-event'), require('event-drops')) :
    typeof define === 'function' && define.amd ? define('warpview', ['exports', '@angular/core', '@angular/common', 'moment-timezone', 'deep-equal', 'plotly.js/dist/plotly', 'plotly.js', 'rxjs', 'rxjs/operators', 'rxjs/internal/observable/of', '@angular/common/http', 'fitty', 'moment', 'd3', 'd3-selection', 'leaflet', 'leaflet.heat', 'leaflet.markercluster', 'nouislider', '@angular/forms', 'angular-resize-event', 'event-drops'], factory) :
    (global = global || self, factory(global.warpview = {}, global.ng.core, global.ng.common, global.moment__default, global.deepEqual, global.plotly, global.plotly.js, global.rxjs, global.rxjs.operators, global.rxjs['internal/observable/of'], global.ng.common.http, global.fitty, global.moment, global.d3, global.d3Selection, global.Leaflet, null, null, global.nouislider, global.ng.forms, global.angularResizeEvent, global.eventDrops));
}(this, (function (exports, core, common, moment__default, deepEqual, plotly, plotly_js, rxjs, operators, of, http, fitty, moment, d3, d3Selection, Leaflet, leaflet_heat, leaflet_markercluster, nouislider, forms, angularResizeEvent, eventDrops) { 'use strict';
    ...
    fitty = fitty && fitty.hasOwnProperty('default') ? fitty['default'] : fitty;
    moment = moment && moment.hasOwnProperty('default') ? moment['default'] : moment;
    Leaflet = Leaflet && Leaflet.hasOwnProperty('default') ? Leaflet['default'] : Leaflet;
    eventDrops = eventDrops && eventDrops.hasOwnProperty('default') ? eventDrops['default'] : eventDrops;
    ...
    ***************************************************************************** */
    ...
    var PlotlyComponent = /** @class */ (function () {
        ...
        function (properties, curves) {
            plotly.restyle(this.plotlyInstance, properties, curves);
        };
        /**
         * @return {?}
         */
        ...
        function () {
            ...
            return plotly.react(this.plotEl.nativeElement, this.data, this.layout, this.config).then((/**
        ...
        function () {
            ...
            if (this.useResizeHandler) {
                if (this.resizeHandler === undefined) {
                     ...
                     * @return {?}
                     */
                    function () { return plotly_js.Plots.resize(_this.plotlyInstance); })); });
        ...
        PlotlyComponent.propDecorators = {
            plotEl: [{ type: core.ViewChild, args: ['plot', { static: true },] }],
            ...
            updateOnLayoutChange: [{ type: core.Input }],
            updateOnDataChange: [{ type: core.Input }],
            updateOnlyWithRevision: [{ type: core.Input }],
    ...
    var WarpViewComponent = /** @class */ (function () {
        function WarpViewComponent(el, renderer, sizeService, ngZone) {
            ...
            this.chartDraw = new core.EventEmitter();
            ...
            if (this._options.bounds && this._options.bounds.minDate && this._options.bounds.maxDate) {
                ...
                if (this._options.timeMode && this._options.timeMode === 'timestamp') {
                    ...
                    this.layout.xaxis.range = [
                        moment__default.tz(dataModel.bounds.xmin / this.divider, this._options.timeZone).toISOString(true),
                        moment__default.tz(dataModel.bounds.xmax / this.divider, this._options.timeZone).toISOString(true)
                    ];
                }
            }
        ...
        WarpViewComponent.propDecorators = {
            toolTip: [{ type: core.ViewChild, args: ['toolTip', { static: true },] }],
            graph: [{ type: core.ViewChild, args: ['graph', { static: false },] }],
            chartContainer: [{ type: core.ViewChild, args: ['chartContainer', { static: true },] }],
            width: [{ type: core.Input, args: ['width',] }],
            height: [{ type: core.Input, args: ['height',] }],
            hiddenData: [{ type: core.Input, args: ['hiddenData',] }],
            unit: [{ type: core.Input, args: ['unit',] }],
            debug: [{ type: core.Input, args: ['debug',] }],
            showLegend: [{ type: core.Input, args: ['showLegend',] }],
            responsive: [{ type: core.Input, args: ['responsive',] }],
            options: [{ type: core.Input, args: ['options',] }],
            data: [{ type: core.Input, args: ['data',] }],
            chartDraw: [{ type: core.Output, args: ['chartDraw',] }]
        };
    ...
    var WarpViewChartComponent = /** @class */ (function (_super) {
        ...
        function WarpViewChartComponent(el, renderer, sizeService, ngZone) {
            ...
            _this.boundsDidChange = new core.EventEmitter();
            _this.pointHover = new core.EventEmitter();
            _this.warpViewChartResize = new core.EventEmitter();
        ...
        function (reparseNewData) {
            ...
            if (!!this._options.timeMode && this._options.timeMode === 'timestamp') {
                ...
                this.layout.xaxis.tick0 = moment__default__default.tz(this.minTick / this.divider, this._options.timeZone).toISOString(true);
            }
            ...
            if (this._options.timeMode && this._options.timeMode === 'timestamp') {
                ...
                x.tick0 = moment__default__default.tz(min / this.divider, this._options.timeZone).toISOString(true);
                x.range = [
                    moment__default__default.tz(min / this.divider, this._options.timeZone).toISOString(true),
                    moment__default__default.tz(max / this.divider, this._options.timeZone).toISOString(true)
                ];
            }
            this.layout.xaxis = x;
            this.layout = __assign({}, this.layout);
            this.loading = false;
            this.highliteCurve.pipe(operators.debounceTime(200)).subscribe((/**
             * @param {?} value
             * @return {?}
             */
            function (value) {
            ...
            this.unhighliteCurve.pipe(operators.debounceTime(200)).subscribe((/**
             * @param {?} value
             * @return {?}
             */
            function (value) {
        ...
        function (min, max, marginLeft) {
            if (this._options.timeMode && this._options.timeMode === 'timestamp') {
                ...
                this.boundsDidChange.emit({
                    bounds: {
                        min: moment__default__default.tz(min, this._options.timeZone).valueOf(),
                        max: moment__default__default.tz(max, this._options.timeZone).valueOf(),
                    ...
                    if (gts.v && GTSLib.isGtsToPlot(gts)) {
                        ...
                        if (timestampMode_1 || _this._options.timeMode === 'timestamp') {
                            ...
                            if (_this._options.timeZone !== 'UTC') {
                                 ...
                                 * @return {?}
                                 */
                                function (t) { return moment__default__default.utc(t / _this.divider).tz(_this._options.timeZone).toISOString(); }));
                            }
                            else {
                                series.x = ticks.map((/**
                                 * @param {?} t
                                 * @return {?}
                                 */
                                function (t) { return moment__default__default.utc(t / _this.divider).toISOString(); }));
                            }
                        }
                        series.y = values;
        ...
        function (data) {
            if (data['xaxis.range'] && data['xaxis.range'].length === 2) {
                ...
                this.chartBounds.tsmin = moment__default__default.tz(moment__default__default(this.chartBounds.msmin), this._options.timeZone).valueOf() * this.divider;
                this.chartBounds.tsmax = moment__default__default.tz(moment__default__default(this.chartBounds.msmax), this._options.timeZone).valueOf() * this.divider;
            }
        ...
        function (min, max) {
            ...
            this.LOG.debug(['updateBounds'], moment__default__default.tz(min, this._options.timeZone).toISOString(), moment__default__default.tz(max, this._options.timeZone).toISOString());
            if (this._options.timeMode && this._options.timeMode === 'timestamp') {
                ...
                this.layout.xaxis.range = [
                    moment__default__default.tz(min, this._options.timeZone).toISOString(),
                    moment__default__default.tz(max, this._options.timeZone).toISOString()
                ];
                this.layout.xaxis.tick0 = moment__default__default.tz(min, this._options.timeZone).toISOString();
            }
            this.layout = __assign({}, this.layout);
        ...
        function (chartBounds) {
            ...
            if (this._options.timeMode && this._options.timeMode === 'timestamp') {
                ...
                x.tick0 = moment__default__default.tz(this.minTick / this.divider, this._options.timeZone).toISOString(true);
                x.range = [
                    moment__default__default.tz(this.minTick / this.divider, this._options.timeZone).toISOString(true),
                    moment__default__default.tz(this.maxTick / this.divider, this._options.timeZone).toISOString(true)
                ];
            }
            this.layout.xaxis = x;
            this.layout = __assign({}, this.layout);
        ...
        WarpViewChartComponent.propDecorators = {
            ...
            standalone: [{ type: core.Input, args: ['standalone',] }],
            boundsDidChange: [{ type: core.Output, args: ['boundsDidChange',] }],
            pointHover: [{ type: core.Output, args: ['pointHover',] }],
            warpViewChartResize: [{ type: core.Output, args: ['warpViewChartResize',] }]
        };
    ...
    var Warp10Service = /** @class */ (function () {
        ...
        function (warpScript, url) {
             ...
             * @return {?}
             */
            function (r) { return _this.LOG.debug(['exec', 'result'], r); })), operators.catchError(this.handleError('exec')));
        };
        ...
        /** @nocollapse */ Warp10Service.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function Warp10Service_Factory() { return new Warp10Service(core.ɵɵinject(http.HttpClient), core.ɵɵinject(HttpErrorHandler)); }, token: Warp10Service, providedIn: "root" });
    ...
    var WarpViewTileComponent = /** @class */ (function (_super) {
        ...
        function WarpViewTileComponent(el, sizeService, renderer, ngZone, warp10Service) {
            ...
            _this.warpscriptResult = new core.EventEmitter();
            _this.execStatus = new core.EventEmitter();
            _this.execError = new core.EventEmitter();
            _this.type = 'line';
            _this.url = '';
        ...
        WarpViewTileComponent.propDecorators = {
            warpRef: [{ type: core.ViewChild, args: ['warpRef', { static: true },] }],
            warpscriptResult: [{ type: core.Output, args: ['warpscriptResult',] }],
            execStatus: [{ type: core.Output, args: ['execStatus',] }],
            execError: [{ type: core.Output, args: ['execError',] }],
            type: [{ type: core.Input, args: ['type',] }],
            chartTitle: [{ type: core.Input, args: ['chartTitle',] }],
            url: [{ type: core.Input, args: ['url',] }],
            isAlone: [{ type: core.Input, args: ['isAlone',] }],
            gtsFilter: [{ type: core.Input, args: ['gtsFilter',] }],
            warpscript: [{ type: core.Input }],
            handleKeyDown: [{ type: core.HostListener, args: ['document:keyup', ['$event'],] }]
        };
    ...
    var WarpViewToggleComponent = /** @class */ (function () {
        ...
        WarpViewToggleComponent.propDecorators = {
            ...
            text1: [{ type: core.Input, args: ['text1',] }],
            text2: [{ type: core.Input, args: ['text2',] }],
            stateChange: [{ type: core.Output, args: ['stateChange',] }]
        };
                    ...
                    function (value) {
                        ...
                        if (!_this._options.horizontal) {
                            ...
                            if (_this._options.timeMode && _this._options.timeMode === 'timestamp') {
                                ...
                                series_1.x.push(moment__default__default.tz(moment__default__default.utc(ts / _this.divider), _this._options.timeZone).toISOString());
                            }
                        }
                        else {
                            ...
                            if (_this._options.timeMode && _this._options.timeMode === 'timestamp') {
                                ...
                                series_1.y.push(moment__default__default.tz(moment__default__default.utc(ts / _this.divider), _this._options.timeZone).toISOString());
                            }
                        }
                    }));
    ...
    var WarpViewDatagridComponent = /** @class */ (function (_super) {
         ...
         */
        function (date) {
            return this._options.timeMode === 'date' ? moment__default__default.tz(date / this.divider, this._options.timeZone).toISOString() : date.toString();
        };
        ...
        WarpViewDatagridComponent.propDecorators = {
            elemsCount: [{ type: core.Input, args: ['elemsCount',] }]
        };
    ...
    var WarpViewPaginableComponent = /** @class */ (function () {
        ...
        WarpViewPaginableComponent.propDecorators = {
            ...
            data: [{ type: core.Input, args: ['data',] }],
            elemsCount: [{ type: core.Input, args: ['elemsCount',] }],
            windowed: [{ type: core.Input, args: ['windowed',] }]
        };
    ...
    var WarpViewDisplayComponent = /** @class */ (function (_super) {
        ...
        function (data) {
            ...
            switch (this._options.timeMode) {
                case 'date':
                    this.toDisplay = moment__default__default.tz(parseInt(display, 10) / this.divider, this._options.timeZone).toISOString(true);
                    break;
                case 'duration':
                    /** @type {?} */
                    var start = moment__default__default.tz(parseInt(display, 10) / this.divider, this._options.timeZone);
        ...
        function (start) {
            ...
            function () {
                ...
                _this.toDisplay = moment__default__default.duration(start.diff(now)).humanize(true);
            }), 1000);
        };
    ...
    var CalendarHeatmapComponent = /** @class */ (function () {
        function CalendarHeatmapComponent(el) {
            ...
            this.handler = new core.EventEmitter();
        ...
        function () {
            ...
            // Add day labels
            /** @type {?} */
            var dayLabels = d3.timeDays(moment.utc().startOf('week').toDate(), moment.utc().endOf('week').toDate());
            /** @type {?} */
        ...
        function () {
            ...
            /** @type {?} */
            var dayLabels = d3.timeDays(moment(this.selected.date).startOf('week').toDate(), moment(this.selected.date).endOf('week').toDate());
            /** @type {?} */
            var dayScale = d3.scaleBand()
                .rangeRound([this.labelPadding, this.gHeight])
                .domain(dayLabels.map((/**
        ...
        CalendarHeatmapComponent.propDecorators = {
            debug: [{ type: core.Input, args: ['debug',] }],
            data: [{ type: core.Input, args: ['data',] }],
            minColor: [{ type: core.Input, args: ['minColor',] }],
            maxColor: [{ type: core.Input, args: ['maxColor',] }],
            div: [{ type: core.ViewChild, args: ['chart', { static: true },] }],
            width: [{ type: core.Input, args: ['width',] }],
            height: [{ type: core.Input, args: ['height',] }],
            overview: [{ type: core.Input, args: ['overview',] }],
            handler: [{ type: core.Output, args: ['handler',] }],
    ...
    var WarpViewModalComponent = /** @class */ (function () {
        function WarpViewModalComponent(el) {
            ...
            this.warpViewModalOpen = new core.EventEmitter();
            this.warpViewModalClose = new core.EventEmitter();
            this.opened = false;
        }
        /**
         * @return {?}
        ...
        WarpViewModalComponent.propDecorators = {
            modalTitle: [{ type: core.Input, args: ['modalTitle',] }],
            kbdLastKeyPressed: [{ type: core.Input, args: ['kbdLastKeyPressed',] }],
            warpViewModalOpen: [{ type: core.Output, args: ['warpViewModalOpen',] }],
            warpViewModalClose: [{ type: core.Output, args: ['warpViewModalClose',] }],
            handleKeyDown: [{ type: core.HostListener, args: ['kbdLastKeyPressed', ['$event'],] }]
        };
    ...
    var WarpViewGtsPopupComponent = /** @class */ (function () {
        function WarpViewGtsPopupComponent() {
            this.maxToShow = 5;
            this.warpViewSelectedGTS = new core.EventEmitter();
            this.warpViewModalOpen = new core.EventEmitter();
            this.warpViewModalClose = new core.EventEmitter();
            this.current = 0;
            // tslint:disable-next-line:variable-name
        ...
        WarpViewGtsPopupComponent.propDecorators = {
            ...
            options: [{ type: core.Input, args: ['options',] }],
            gtsList: [{ type: core.Input, args: ['gtsList',] }],
            debug: [{ type: core.Input, args: ['debug',] }],
            data: [{ type: core.Input, args: ['data',] }],
            hiddenData: [{ type: core.Input, args: ['hiddenData',] }],
            maxToShow: [{ type: core.Input, args: ['maxToShow',] }],
            kbdLastKeyPressed: [{ type: core.Input, args: ['kbdLastKeyPressed',] }],
            warpViewSelectedGTS: [{ type: core.Output, args: ['warpViewSelectedGTS',] }],
            warpViewModalOpen: [{ type: core.Output, args: ['warpViewModalOpen',] }],
            warpViewModalClose: [{ type: core.Output, args: ['warpViewModalClose',] }]
        };
    ...
    var WarpViewGtsTreeComponent = /** @class */ (function (_super) {
        ...
        function WarpViewGtsTreeComponent(el, renderer, sizeService, ngZone) {
            ...
            _this.warpViewSelectedGTS = new core.EventEmitter();
            _this._gtsFilter = 'x';
            _this.gtsList = [];
            _this.params = (/** @type {?} */ ([]));
            _this.expand = false;
        ...
        WarpViewGtsTreeComponent.propDecorators = {
            root: [{ type: core.ViewChild, args: ['root', { static: true },] }],
            kbdLastKeyPressed: [{ type: core.Input, args: ['kbdLastKeyPressed',] }],
            gtsFilter: [{ type: core.Input, args: ['gtsFilter',] }],
            warpViewSelectedGTS: [{ type: core.Output, args: ['warpViewSelectedGTS',] }]
        };
    ...
    var WarpViewTreeViewComponent = /** @class */ (function () {
        ...
        WarpViewTreeViewComponent.propDecorators = {
            ...
            gtsFilter: [{ type: core.Input, args: ['gtsFilter',] }],
            gtsList: [{ type: core.Input, args: ['gtsList',] }],
            params: [{ type: core.Input, args: ['params',] }],
            branch: [{ type: core.Input, args: ['branch',] }],
            hidden: [{ type: core.Input, args: ['hidden',] }],
    ...
    var WarpViewChipComponent = /** @class */ (function () {
        ...
        WarpViewChipComponent.propDecorators = {
            chip: [{ type: core.ViewChild, args: ['chip', { static: false },] }],
            name: [{ type: core.Input, args: ['name',] }],
            node: [{ type: core.Input, args: ['node',] }],
            param: [{ type: core.Input, args: ['param',] }],
            options: [{ type: core.Input, args: ['options',] }],
            debug: [{ type: core.Input, args: ['debug',] }],
            hiddenData: [{ type: core.Input, args: ['hiddenData',] }],
            gtsFilter: [{ type: core.Input, args: ['gtsFilter',] }],
    ...
    var WarpViewImageComponent = /** @class */ (function (_super) {
        ...
        WarpViewImageComponent.propDecorators = {
            imageTitle: [{ type: core.Input, args: ['imageTitle',] }],
            onResize: [{ type: core.HostListener, args: ['window:resize',] }]
        };
    ...
    var WarpViewMapComponent = /** @class */ (function () {
        ...
        function (reZoom) {
            ...
            moment__default__default.tz.setDefault(this._options.timeZone);
            /** @type {?} */
            var gts = this._data;
            if (!gts) {
                return;
            ...
            function (t) {
                ...
                if (_this._options.map.showTimeRange) {
                    _this.tileLayerGroup.addLayer(Leaflet.tileLayer(t
                        .replace('{start}', moment__default__default(_this.timeStart).toISOString())
                        .replace('{end}', moment__default__default(_this.timeEnd).toISOString()), {
                        subdomains: 'abcd',
                        maxNativeZoom: 19,
                        maxZoom: 40
                    }));
        ...
        function (gts) {
            ...
            for (var i = 0; i < size; i++) {
                ...
                if (this._options.timeMode && this._options.timeMode === 'timestamp') {
                    ...
                    date = (moment__default__default(parseInt(p.ts, 10))
        ...
        function (event) {
            ...
            this.timeStart = event.value || moment__default__default().valueOf();
            this.timeEnd = event.highValue || moment__default__default().valueOf();
            this.drawMap(true);
        };
        /**
         * @param {?} event
         ...
         */
        function (event) {
            this.LOG.debug(['onSliderChange'], event, moment__default__default(event.value).toISOString());
            this._firstDraw = false;
            if (this.timeEnd !== event.value) {
                this.timeSpan = this.timeSpan || this._options.map.timeSpan;
                this.timeEnd = event.value || moment__default__default().valueOf();
                this.timeStart = (event.value || moment__default__default().valueOf()) - this.timeSpan / this.divider;
                this.LOG.debug(['onSliderChange'], moment__default__default(this.timeStart).toISOString(), moment__default__default(this.timeEnd).toISOString());
        ...
        function (event) {
            ...
            if (this.timeSpan !== event.target.value) {
                ...
                this.timeStart = (this.timeEnd || moment__default__default().valueOf()) - this.timeSpan / this.divider;
                this.drawMap(true);
            }
        };
        ...
        WarpViewMapComponent.propDecorators = {
            mapDiv: [{ type: core.ViewChild, args: ['mapDiv', { static: true },] }],
            wrapper: [{ type: core.ViewChild, args: ['wrapper', { static: true },] }],
            timeSlider: [{ type: core.ViewChild, args: ['timeSlider', { static: false },] }],
            timeRangeSlider: [{ type: core.ViewChild, args: ['timeRangeSlider', { static: false },] }],
            heatData: [{ type: core.Input, args: ['heatData',] }],
            responsive: [{ type: core.Input, args: ['responsive',] }],
            showLegend: [{ type: core.Input, args: ['showLegend',] }],
            width: [{ type: core.Input, args: ['width',] }],
            height: [{ type: core.Input, args: ['height',] }],
    ...
    var WarpViewHeatmapSlidersComponent = /** @class */ (function () {
        function WarpViewHeatmapSlidersComponent() {
            this.heatRadiusDidChange = new core.EventEmitter();
            this.heatBlurDidChange = new core.EventEmitter();
            this.heatOpacityDidChange = new core.EventEmitter();
        }
        /**
         * @param {?} value
         * @return {?}
        ...
        WarpViewHeatmapSlidersComponent.propDecorators = {
            radiusValue: [{ type: core.Input, args: ['radiusValue',] }],
            minRadiusValue: [{ type: core.Input, args: ['minRadiusValue',] }],
            maxRadiusValue: [{ type: core.Input, args: ['maxRadiusValue',] }],
            blurValue: [{ type: core.Input, args: ['blurValue',] }],
            minBlurValue: [{ type: core.Input, args: ['minBlurValue',] }],
            maxBlurValue: [{ type: core.Input, args: ['maxBlurValue',] }],
            heatRadiusDidChange: [{ type: core.Output, args: ['heatRadiusDidChange',] }],
            heatBlurDidChange: [{ type: core.Output, args: ['heatBlurDidChange',] }],
            heatOpacityDidChange: [{ type: core.Output, args: ['heatOpacityDidChange',] }]
        };
    ...
    var WarpViewPieComponent = /** @class */ (function (_super) {
        ...
        function WarpViewPieComponent(el, renderer, sizeService, ngZone) {
            ...
            _this.sizeService = sizeService;
            _this.ngZone = ngZone;
            _this.chartDraw = new core.EventEmitter();
            _this._type = 'pie';
            _this.layout = {
                showlegend: true,
                legend: {
    ...
    var WarpViewAnnotationComponent = /** @class */ (function (_super) {
        ...
        function (min, max, marginLeft) {
            ...
            this.layout.xaxis.autorange = false;
            this.LOG.debug(['updateBounds'], moment__default__default.tz(min / this.divider, this._options.timeZone).toISOString(), moment__default__default.tz(max / this.divider, this._options.timeZone).toISOString());
            this.minTick = min;
            this.maxTick = max;
            if (this._options.timeMode && this._options.timeMode === 'timestamp') {
                ...
                this.layout.xaxis.tick0 = moment__default__default.tz(min / this.divider, this._options.timeZone).toISOString();
                this.layout.xaxis.range = [
                    moment__default__default.tz(min / this.divider, this._options.timeZone).toISOString(),
                    moment__default__default.tz(max / this.divider, this._options.timeZone).toISOString()
                ];
            }
        ...
        function (data) {
            if (data['xaxis.range'] && data['xaxis.range'].length === 2) {
                ...
                this.chartBounds.msmin = data['xaxis.range'][0];
                this.chartBounds.msmax = data['xaxis.range'][1];
                this.chartBounds.tsmin = moment__default__default.tz(moment__default__default(this.chartBounds.msmin), this._options.timeZone).valueOf();
                this.chartBounds.tsmax = moment__default__default.tz(moment__default__default(this.chartBounds.msmax), this._options.timeZone).valueOf();
            }
            else if (data['xaxis.range[0]'] && data['xaxis.range[1]']) {
                this.LOG.debug(['relayout', 'updateBounds', 'xaxis.range[x]'], data['xaxis.range[0]']);
                this.chartBounds.msmin = data['xaxis.range[0]'];
            ...
            this.emitNewBounds(moment__default__default.utc(this.chartBounds.tsmin).valueOf(), moment__default__default.utc(this.chartBounds.msmax).valueOf());
        };
        /**
         * @param {?} data
         * @return {?}
        ...
        WarpViewAnnotationComponent.propDecorators = {
            ...
            chartDraw: [{ type: core.Output, args: ['chartDraw',] }],
            boundsDidChange: [{ type: core.Output, args: ['boundsDidChange',] }],
            handleKeyDown: [{ type: core.HostListener, args: ['keydown', ['$event'],] }, { type: core.HostListener, args: ['document:keydown', ['$event'],] }],
            handleKeyup: [{ type: core.HostListener, args: ['keyup', ['$event'],] }, { type: core.HostListener, args: ['document:keyup', ['$event'],] }]
        };
            ...
            function (gts, i) {
                ...
                function (value) {
                    ...
                    if (_this._options.timeMode && _this._options.timeMode === 'timestamp') {
                        ...
                        series.theta.push(moment__default__default.tz(moment__default__default.utc(ts / _this.divider), _this._options.timeZone).toISOString());
                    }
                }));
                if (_this.unit) {
                    series.title = {
    ...
    var WarpViewPlotComponent = /** @class */ (function (_super) {
        ...
        function (event) {
            ...
            if (this._options.bounds.minDate !== event.bounds.min && this._options.bounds.maxDate !== event.bounds.max) {
                ...
                this.LOG.debug(['updateBounds'], moment__default__default.tz(event.bounds.min, this._options.timeZone).toDate(), moment__default__default.tz(event.bounds.max, this._options.timeZone).toDate());
                    ...
                    switch (_c.label) {
                        ...
                        case 5:
                            ...
                            if (ev.key === '/') {
                                 ...
                                 */
                                function (tc) {
                                    _this.timeClipValue = "<p>keep data between\n          " + (_this._options.timeMode === 'timestamp' ? tc.tsmin : moment__default__default.tz(tc.tsmin, _this._options.timeZone).toLocaleString()) + " and\n          " + (_this._options.timeMode === 'timestamp' ? tc.tsmax : moment__default__default.tz(tc.tsmax, _this._options.timeZone).toLocaleString()) + "\n          " + (_this._options.timeUnit !== 'us' ? ' (for a ' + _this._options.timeUnit + ' platform)' : '') + "</p>\n          <pre><code>" + Math.round(tc.tsmax) + " " + Math.round(tc.tsmax - tc.tsmin) + " TIMECLIP</code></pre>";
                                    _this.timeClip.open();
                                }));
                            }
         ...
         */
        function () {
            return moment__default__default.tz.names();
        };
        /**
         * @protected
         * @param {?} data
        ...
        WarpViewPlotComponent.propDecorators = {
            mainPlotDiv: [{ type: core.ViewChild, args: ['mainPlotDiv', { static: true },] }],
            timeClip: [{ type: core.ViewChild, args: ['timeClip', { static: true },] }],
            modal: [{ type: core.ViewChild, args: ['modal', { static: true },] }],
            chart: [{ type: core.ViewChild, args: ['chart', { static: false },] }],
            gtsPopupModal: [{ type: core.ViewChild, args: ['gtsPopupModal', { static: false },] }],
            annotation: [{ type: core.ViewChild, args: ['annotation', { static: false },] }],
            map: [{ type: core.ViewChild, args: ['map', { static: false },] }],
            timeClipElement: [{ type: core.ViewChild, args: ['timeClipElement', { static: true },] }],
            GTSTree: [{ type: core.ViewChild, args: ['GTSTree', { static: true },] }],
            controls: [{ type: core.ViewChild, args: ['controls', { static: true },] }],
            filterInput: [{ type: core.ViewChild, args: ['filterInput', { static: true },] }],
            tzSelector: [{ type: core.ViewChild, args: ['tzSelector', { static: false },] }],
            line: [{ type: core.ViewChild, args: ['line', { static: false },] }],
            main: [{ type: core.ViewChild, args: ['main', { static: false },] }],
            type: [{ type: core.Input, args: ['type',] }],
            gtsFilter: [{ type: core.Input, args: ['gtsFilter',] }],
            isAlone: [{ type: core.Input, args: ['isAlone',] }],
            initialChartHeight: [{ type: core.Input, args: ['initialChartHeight',] }],
            initialMapHeight: [{ type: core.Input, args: ['initialMapHeight',] }],
            warpViewChartResize: [{ type: core.Output, args: ['warpViewChartResize',] }],
    ...
    var WarpViewResizeComponent = /** @class */ (function () {
        ...
        WarpViewResizeComponent.propDecorators = {
            handleDiv: [{ type: core.ViewChild, args: ['handleDiv', { static: true },] }],
            wrapper: [{ type: core.ViewChild, args: ['wrapper', { static: true },] }],
            minHeight: [{ type: core.Input, args: ['minHeight',] }],
            initialHeight: [{ type: core.Input, args: ['initialHeight',] }],
            debug: [{ type: core.Input, args: ['debug',] }],
            resize: [{ type: core.Output, args: ['resize',] }]
        };
    ...
    var WarpViewSliderComponent = /** @class */ (function () {
        function WarpViewSliderComponent() {
            ...
            this._step = 0;
            this.loaded = false;
            this.manualRefresh = new core.EventEmitter();
            this._debug = false;
    ...
    var WarpViewRangeSliderComponent = /** @class */ (function (_super) {
        ...
        WarpViewRangeSliderComponent.propDecorators = {
            slider: [{ type: core.ViewChild, args: ['slider', { static: false },] }],
            minValue: [{ type: core.Input, args: ['minValue',] }],
            maxValue: [{ type: core.Input, args: ['maxValue',] }]
        };
                ...
                if (gts.v) {
                    ...
                    function (value) {
                        ...
                        if (_this._type === 'box-date') {
                            series_1.x.push(moment__default__default.tz(moment__default__default.utc(value[0] / _this.divider), _this._options.timeZone).toISOString());
                        }
                    }));
                    dataset.push(series_1);
                }
    ...
    var WarpViewEventDropComponent = /** @class */ (function (_super) {
        ...
        function (min, max) {
            ...
            if (this._options.timeMode && this._options.timeMode === 'timestamp') {
                ...
                this.eventConf['range'] = {
                    start: moment__default__default.tz(moment__default__default.utc(this.minTick / this.divider), this._options.timeZone).toDate(),
                    end: moment__default__default.tz(moment__default__default.utc(this.maxTick / this.divider), this._options.timeZone).toDate(),
                };
            }
        ...
        function () {
            ...
            if (this.elemChart.nativeElement) {
                 ...
                 * @return {?}
                 */
                function () { return d3Selection.select(_this.elemChart.nativeElement).data([_this.plotlyData]).call(eventDrops(_this.eventConf)); }));
                this.loading = false;
                this.chartDraw.emit();
            }
        };
            ...
            function (gts, i) {
                ...
                function (value) {
                    ...
                    if (_this._options.timeMode && _this._options.timeMode === 'timestamp') {
                        ...
                        dataSet.data.push({
                            date: moment__default__default.tz(moment__default__default.utc(ts / _this.divider), _this._options.timeZone).toDate(),
                            color: color,
        ...
        WarpViewEventDropComponent.propDecorators = {
            elemChart: [{ type: core.ViewChild, args: ['elemChart', { static: true },] }],
            type: [{ type: core.Input, args: ['type',] }],
            hiddenData: [{ type: core.Input, args: ['hiddenData',] }],
            pointHover: [{ type: core.Output, args: ['pointHover',] }],
            warpViewChartResize: [{ type: core.Output, args: ['warpViewChartResize',] }],
    ...
    exports.ɵa = WarpViewTileComponent;
    exports.ɵb = WarpViewComponent;
    exports.ɵba = WarpViewPolarComponent;
    exports.ɵbb = WarpViewRadarComponent;
    exports.ɵbc = WarpViewPlotComponent;
    exports.ɵbd = WarpViewResizeComponent;
    exports.ɵbe = WarpViewSliderComponent;
    exports.ɵbf = WarpViewRangeSliderComponent;
    exports.ɵbg = WarpViewSpectrumComponent;
    exports.ɵbh = PlotlyComponent;
    exports.ɵbi = WarpViewBoxComponent;
    exports.ɵbj = WarpView3dLineComponent;
    exports.ɵbk = WarpViewGlobeComponent;
    exports.ɵbl = WarpViewEventDropComponent;
    exports.ɵbm = WarpViewResultTileComponent;
    exports.ɵc = SizeService;
    exports.ɵd = HttpErrorHandler;
    exports.ɵe = Warp10Service;
    exports.ɵf = WarpViewChartComponent;
    exports.ɵg = WarpViewSpinnerComponent;
    exports.ɵh = WarpViewToggleComponent;
    exports.ɵi = WarpViewBarComponent;
    exports.ɵj = WarpViewBubbleComponent;
    exports.ɵk = WarpViewDatagridComponent;
    exports.ɵl = WarpViewPaginableComponent;
    exports.ɵm = WarpViewDisplayComponent;
    exports.ɵn = WarpViewDrillDownComponent;
    exports.ɵo = CalendarHeatmapComponent;
    exports.ɵp = WarpViewGtsPopupComponent;
    exports.ɵq = WarpViewModalComponent;
    exports.ɵr = WarpViewGtsTreeComponent;
    exports.ɵs = WarpViewTreeViewComponent;
    exports.ɵt = WarpViewChipComponent;
    exports.ɵu = WarpViewImageComponent;
    exports.ɵv = WarpViewMapComponent;
    exports.ɵw = WarpViewHeatmapSlidersComponent;
    exports.ɵx = WarpViewPieComponent;
    exports.ɵy = WarpViewGaugeComponent;
    exports.ɵz = WarpViewAnnotationComponent;
